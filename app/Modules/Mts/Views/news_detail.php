        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <nav aria-label="breadcrumb" class="mb-4">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= site_url('mts') ?>" class="text-decoration-none">Beranda</a></li>
                        <li class="breadcrumb-item"><a href="<?= site_url('mts/kabar') ?>" class="text-decoration-none">Kabar Sekolah</a></li>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <div class="mt-5 pt-4 border-top d-flex justify-content-between align-items-center flex-wrap gap-3">
                            <a href="<?= site_url('mts/kabar') ?>" class="btn btn-outline-secondary rounded-pill px-4">
                            ...
                            <div class="col-8">
                                <div class="card-body py-2 pe-2">
                                    <h6 class="card-title fw-bold mb-1 small">
                                        <a href="<?= site_url('mts/kabar/'.$rn['slug']) ?>" class="text-decoration-none text-dark hover-purple text-clamp-2">
                                            <?= esc($rn['title']) ?>
                                        </a>
                                    </h6>
