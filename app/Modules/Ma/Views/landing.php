        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                <div class="d-flex justify-content-between align-items-end mb-4">
                    ...
                    <a href="<?= site_url('ma/kabar') ?>" class="btn btn-sm btn-outline-purple rounded-pill px-3">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body p-4 h-100 d-flex flex-column">
                                            ...
                                            <h5 class="card-title fw-bold mb-2">
                                                <a href="<?= site_url('ma/kabar/' . $n['slug']) ?>" class="text-decoration-none text-dark hover-purple">
                                                    <?= esc($n['title']) ?>
                                                </a>
                                            </h5>
                                            ...
                                            <div class="mt-auto">
                                                <a href="<?= site_url('ma/kabar/' . $n['slug']) ?>" class="btn btn-sm btn-purple rounded-pill px-4 shadow-sm">
                                                    Baca Selengkapnya
                                                </a>
                                            </div>
                                        </div>
            ...
            <div class="col-lg-4">
                <div class="d-flex justify-content-between align-items-end mb-4">
                    ...
                    <a href="<?= site_url('ma/agenda') ?>" class="text-decoration-none small fw-bold text-purple">
                                ...
                                <div class="d-flex gap-3 align-items-start group-hover">
                                    ...
                                    <div>
                                        <h6 class="fw-bold mb-1 text-dark hover-purple transition-color">
                                            <a href="<?= site_url('ma/agenda/' . $e['slug']) ?>" class="text-reset text-decoration-none">
                                                <?= esc($e['title']) ?>
                                            </a>
                                        </h6>
...
<section id="galeri" class="py-5 bg-white position-relative">
    ...
    <div class="container position-relative z-1">
        <div class="d-flex justify-content-between align-items-end mb-5">
            ...
            <a href="<?= site_url('ma/galeri') ?>" class="btn btn-outline-purple rounded-pill px-4 fw-bold d-none d-md-inline-block hover-lift-sm">
                Lihat Semua <i class="bi bi-arrow-right ms-1"></i>
            </a>
        </div>
