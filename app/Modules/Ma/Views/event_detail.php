        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <nav aria-label="breadcrumb" class="mb-4">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= site_url('ma') ?>" class="text-decoration-none">Beranda</a></li>
                        <li class="breadcrumb-item"><a href="<?= site_url('ma/agenda') ?>" class="text-decoration-none">Agenda</a></li>
                ...
                <div class="card border-0 shadow rounded-4 overflow-hidden">
                    ...
                    <div class="card-body p-4 p-lg-5">
                        ...
                        <div class="mt-5 text-center">
                            <a href="<?= site_url('ma/agenda') ?>" class="btn btn-outline-secondary rounded-pill px-4">
