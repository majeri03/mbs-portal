        ...
        <div class="col-lg-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <form action="" method="get" class="d-flex gap-2">
                    ...
                    <?php if($active_filter): ?>
                        <a href="<?= site_url('ma/informasi') ?>" class="btn btn-sm btn-light rounded-circle shadow-sm d-flex align-items-center justify-content-center" style="width: 31px; height: 31px;">
                    ...
                    <?php if(!empty($pages_list)): ?>
                        <div class="list-group list-group-flush custom-list">
                            <?php foreach($pages_list as $p): ?>
                                <a href="<?= site_url('ma/halaman/' . $p['slug']) ?>" class="list-group-item list-group-item-action d-flex align-items-center py-3 px-4">
            ...
            <div class="text-center mt-4">
                <a href="<?= site_url('ma') ?>" class="btn btn-outline-purple rounded-pill px-4">
