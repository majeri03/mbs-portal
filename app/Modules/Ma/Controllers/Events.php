...
class Events extends BaseMaController
{
   ...
   // Modules/Ma/Controllers/Events.php
    ...
    public function index()
    {
        ...
        return view('Modules\Ma\Views\events_index', $this->data);
    }
    ...
    public function show($slug)
    {
        ...
        return view('Modules\Ma\Views\event_detail', $this->data);
    }
}
