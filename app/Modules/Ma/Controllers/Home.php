...
// PENTING: Extend ke BaseMaController, bukan BaseController biasa
class Home extends BaseMaController
{
    public function index()
    {
        ...
        // Masukkan data ke variabel $this->data (warisan dari BaseMaController)
        ...
        return view('Modules\Ma\Views\landing', $this->data);
    }
}
