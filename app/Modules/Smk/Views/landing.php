                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="card border-0 shadow-sm rounded-4 p-4 p-lg-5">
                            ...
                            <div class="content-body text-secondary lh-lg text-center">
                                <?php
                                // 1. Hapus tag HTML (gambar, bold, tabel, dll) agar bersih
                                $clean_content = strip_tags($page['content']);

                                // 2. Potong teks jika lebih dari 250 karakter
                                if (strlen($clean_content) > 250) {
                                    echo substr($clean_content, 0, 250) . '...';
                                } else {
                                    echo $clean_content;
                                }
                                ?>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                <div class="d-flex justify-content-between align-items-end mb-4">
                    ...
                    <a href="<?= site_url('smk/kabar') ?>" class="btn btn-sm btn-outline-purple rounded-pill px-3">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body p-4 h-100 d-flex flex-column">
                                            ...
                                            <h5 class="card-title fw-bold mb-2">
                                                <a href="<?= site_url('smk/kabar/' . $n['slug']) ?>" class="text-decoration-none text-dark hover-purple">
                                                    <?= esc($n['title']) ?>
                                                </a>
                                            </h5>
                                            ...
                                            <div class="mt-auto">
                                                <a href="<?= site_url('smk/kabar/' . $n['slug']) ?>" class="btn btn-sm btn-purple rounded-pill px-4 shadow-sm">
                                                    Baca Selengkapnya
                                                </a>
                                            </div>
                                        </div>
            ...
            <div class="col-lg-4">
                <div class="d-flex justify-content-between align-items-end mb-4">
                    ...
                    <a href="<?= site_url('smk/agenda') ?>" class="text-decoration-none small fw-bold text-purple">
                                ...
                                <div class="d-flex gap-3 align-items-start group-hover">
                                    ...
                                    <div>
                                        <h6 class="fw-bold mb-1 text-dark hover-purple transition-color">
                                            <a href="<?= site_url('smk/agenda/' . $e['slug']) ?>" class="text-reset text-decoration-none">
                                                <?= esc($e['title']) ?>
                                            </a>
                                        </h6>
...
<section id="galeri" class="py-5 bg-white position-relative">
    ...
    <div class="container position-relative z-1">
        <div class="d-flex justify-content-between align-items-end mb-5">
            ...
            <a href="<?= site_url('smk/galeri') ?>" class="btn btn-outline-purple rounded-pill px-4 fw-bold d-none d-md-inline-block hover-lift-sm">
                Lihat Semua <i class="bi bi-arrow-right ms-1"></i>
            </a>
        </div>
...
<script>
    ...
    // Inisialisasi Swiper Pengumuman (Vertical Slide)
    var announcementSwiper = new Swiper(".announcementSwiper", {
        direction: "vertical", // Bergerak ke atas (seperti chat scroll)
        loop: true,
        autoplay: {
            delay: 4000, // Ganti setiap 4 detik
            disableOnInteraction: false,
        },
        speed: 800,
        allowTouchMove: false, // Biar tidak digeser manual (auto saja)
    });

    // Opsional: Auto close jika klik di luar widget
    document.addEventListener('click', function(event) {
        var container = document.querySelector('.floating-anno-container');
        var panel = document.getElementById("annoPanel");

        // Jika klik terjadi di luar container DAN panel sedang terbuka
        if (!container.contains(event.target) && panel.classList.contains('active')) {
