...
class Documents extends BaseSmkController
{
    ...
    public function index()
    {
        ...
        if ($this->request->isAJAX()) {
            ...
            return view('Modules\Smk\Views\documents_data', $this->data);
        }
        return view('Modules\Smk\Views\documents_index', $this->data);
    }
