...
<div class="mb-4">
    <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <?php if (session('role') === 'guru'): ?>
            <!-- Guru: Kembali ke Dashboard -->
            <a href="<?= base_url('admin/dashboard') ?>" class="btn btn-sm btn-light">
                <i class="bi bi-arrow-left me-1"></i> Kembali ke Dashboard
            </a>
        <?php else: ?>
            <!-- Admin/Superadmin: Kembali ke Kelola Agenda -->
            <a href="<?= base_url('admin/events') ?>" class="btn btn-sm btn-light">
                <i class="bi bi-arrow-left me-1"></i> Kembali ke Kelola Agenda
            </a>
        <?php endif; ?>
    </div>
