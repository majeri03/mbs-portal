            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="general">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-white py-3"><h6 class="mb-0 fw-bold">Identitas Website</h6></div>
                ...
                <div class="tab-pane fade" id="profile">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-white py-3"><h6 class="mb-0 fw-bold">Sambutan & Video Profil</h6></div>
                        <div class="card-body p-4">
                            <div class="mb-3">
                ...
                <div class="tab-pane fade" id="contact">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-white py-3"><h6 class="mb-0 fw-bold">Kontak, Sosmed & Lokasi</h6></div>
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="col-md-6 mb-3">
